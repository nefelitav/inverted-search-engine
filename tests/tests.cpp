...
void test_lookup_entry_index(void) {
    ...
    tree->addEntry(&testEntry2, 1, 1);
    tree->addEntry(&testEntry3, 1, 1);
    tree->addEntry(&testEntry4, 1, 1);
    tree->addEntry(&testEntry5, 1, 1);
    tree->addEntry(&testEntry6, 1, 1);
    ...
    TEST_CHECK(lookup_entry_index(&text1,tree, 0, result) == EC_SUCCESS);
    ...
    TEST_CHECK ( lookup_entry_index(&text2, tree, 0, result) == EC_SUCCESS);
    resultNode = result->getHead();
    TEST_CHECK ( resultNode == NULL);
    destroy_entry_list(result);
    ...
    create_entry_list(&result);
    TEST_CHECK ( lookup_entry_index(&text3, tree, 1, result) == EC_SUCCESS);
    ...
    create_entry_list(&result);
    TEST_CHECK ( lookup_entry_index(&text5, tree, 0, result) == EC_SUCCESS);
    resultNode = result->getHead();
    TEST_CHECK(strcmp(resultNode->getWord(),testEntry3->getWord())==0);
    resultNode = resultNode->getNext();
    TEST_CHECK(resultNode == NULL);
...
void test_addToIndex(void) {
    ...
    addToIndex(&testEntry2, 2, MT_EDIT_DIST ,2);
    addToIndex(&testEntry3, 3, MT_EDIT_DIST ,3);
    addToIndex(&testEntry4, 4, MT_EDIT_DIST ,4);
    addToIndex(&testEntry5, 5, MT_EDIT_DIST ,5);
    addToIndex(&testEntry6, 6, MT_EDIT_DIST ,6);

    // Search for a word
    const word wordToFind = (char*)"TESTWORD\0";
    create_entry_list(&result);
    TEST_CHECK ( lookup_entry_index(&wordToFind, editIndex, 1, result) == EC_SUCCESS);
    // Test that only the correct words matched
    resultNode = result->getHead();
    TEST_CHECK(strcmp(resultNode->getWord(),testEntry6->getWord())==0);
    resultNode = resultNode->getNext();
...
void test_removeFromIndex(void) {
    ...
    test_list->addEntry(testEntry2);
    test_list->addEntry(testEntry1);
    indexNode* tree = new indexNode(&testEntry1, 1, 1);
    tree->addEntry(&testEntry2, 2, 2);
    tree->addEntry(&testEntry3, 3, 3);
    tree->addEntry(&testEntry4, 4, 4);
    tree->addEntry(&testEntry5, 5, 5);
    tree->addEntry(&testEntry6, 6, 6);
    indexNode* nullTree = NULL;
    const word text1 = (char*)"TESTWOR22\0";
    const word nullText = NULL;
    ...
    removeFromIndex(tree, &textToRemove, 1, MT_EDIT_DIST);
